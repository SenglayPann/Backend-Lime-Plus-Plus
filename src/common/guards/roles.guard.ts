...
const ROLE_HIERARCHY: Record<Role, Role[]> = {
  ...
  PROJECT_MANAGER: ['PROJECT_MANAGER', 'PROJECT_LEAD', 'PROJECT_MEMBER', 'ORGANIZATION_MEMBER'],
  PROJECT_LEAD: ['PROJECT_LEAD', 'PROJECT_MEMBER', 'ORGANIZATION_MEMBER'],
  PROJECT_MEMBER: ['PROJECT_MEMBER', 'ORGANIZATION_MEMBER'],
